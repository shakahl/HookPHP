...
class HookModel extends \Base\AbstractModel
{
    ...
    {
        return $this->orm->queryAll(Yaconf::get('dicPdo.HOOK.HOOK.GET_ALL'), [APP_LANG_ID]);
    }

    public function getSelect(): array
    {
        return $this->orm->queryAll(Yaconf::get('dicPdo.HOOK.HOOK.GET_SELECT'), [APP_LANG_ID], \PDO::FETCH_KEY_PAIR);
    }
}